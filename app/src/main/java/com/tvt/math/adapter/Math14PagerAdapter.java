...
public class Math14PagerAdapter extends BaseViewPagerAdapter<MathTenBean> {

    @Override
    View updateView(ViewGroup container, final int position, final MathTenBean item) {
        View view = LayoutInflater.from(container.getContext()).inflate(R.layout.math_14_item_view, container, false);
